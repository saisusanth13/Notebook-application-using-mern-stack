...
const SignUp = () => {
    ...
    const handleSubmit = async (e)=>{
        ...
        const response = await fetch("http://localhost:3008/api/auth/createuser", {
  ...
  return (
   ...
   <div className="container flex justify-center">
    ...
    <div className="px-4 w-96 text-left bg-black shadow-lg">
        <h3 className="text-2xl -mt-1 text-center  text-white hover:text-neutral-400 font-bold font-serif">SignUp</h3>
        <form action="" onSubmit={handleSubmit}>
            <div className="mt-4">
                <div>
                    <label className="block text-white hover:text-neutral-400 font-bold text-sm font-serif" htmlFor="email">Name</label>
                ...
                <div className="mt-4">
                    <label className="block text-white hover:text-neutral-400 font-bold text-sm font-serif">Password</label>
                            <input type="password" placeholder="Password" name="password" onChange={onChange} required minLength={5}
                ...
                <div className="mt-2">
                    <label className="block text-white hover:text-neutral-400 font-bold text-sm font-serif">Confirm Password</label>
                            <input type="password" placeholder="Password" name="cpassword" onChange={onChange}
                                className="w-full px-4 py-2 mt-2 border rounded-md  text-black  font-bold text-sm font-serif focus:outline-none focus:ring-1 focus:ring-blue-600" required minLength={5} />
                </div>
